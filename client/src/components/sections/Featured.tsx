...
import ilmeniteImg from "@assets/generated_images/african_workers_loading_ilmenite_ore_ship.png";
import flexpipeImg from "@assets/generated_images/african_workers_flexpipe_trench_installation.png";
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2 relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-slate-200">
                <img
                  src={ilmeniteImg}
                  alt="Ilmenite ore loading into ship"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2 relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-slate-200">
                <img
                  src={flexpipeImg}
                  alt="Flexpipe spooled installation in trench"
                  className="w-full h-full object-cover hover:scale-105 transition-transform duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-primary/40 to-transparent pointer-events-none" />
              </div>
